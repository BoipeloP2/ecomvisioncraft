            ...
            <div className="row">
                    ...
                    <div className='filter-card mb-3'>
                        ...
                        <div>
                            ...
                            <div className="form-check">
                                ...
                                <label htmlFor="size-2" className="form-check-label">M(2)</label>
                            </div>
                        </div>
                ...
                <div className="col-9">
                    <div className="filter-sort-grid mb-4">
                        ...
                        <img onClick={()=>{
                            setGrid(3);
                        }} src="images/gr4.svg" className='d-block img-fluid' alt="" />
                        <img onClick={()=>{
                            setGrid(4);
                        }} src="images/gr3.svg" className='d-block img-fluid' alt="" />
                         <img onClick={()=>{
                            setGrid(6);
                         }} src="images/gr2.svg" className='d-block img-fluid' alt="" />
                         <img onClick={()=>{
                            setGrid(12);
                         }} src="images/gr.svg" className='d-block img-fluid' alt="" />
